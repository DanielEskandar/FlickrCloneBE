  ...
  test('should retrieve sizes, comment, favourites, views, tags, date uploaded, date taken, location, title description, exif, content type and people tagged.', async () => {
    ...
    expect(mRes.send).toBeCalledWith({
      ...
      data: {
        ...
        comments: [new mongoose.Types.ObjectId('608d5450ec16665468617a0c')],
        favourites: 119,
        views: 541,
        tags: ['#Amesterdam', '#Colorful', '#SunnyDay'],
        dateUploaded: new Date('2018-12-23T18:29:43.511Z'),
        dateTaken: new Date('2017-07-12T18:25:47.511Z'),
        location: new mongoose.Types.ObjectId('608d5450ec00005468604a1c'),
        ...
        peopleTagged: [
          {
            _id: new mongoose.Types.ObjectId('60907e13495ac0316c2b19cb'),
            userId: new mongoose.Types.ObjectId('608d55c7e512b74ee00791de'),
            tagDate: new Date('2021-01-13T18:25:43.511Z'),
          },
        ],
        __v: 0,
      },
  ...
  test('should retrieve sizes, comment, favourites, views, tags, date uploaded, date taken, location, title description, exif, content type and people tagged.', async () => {
    ...
    expect(mRes.send).toBeCalledWith({
      ...
      data: {
        ...
        comments: [new mongoose.Types.ObjectId('608d5450ec10005468617a0c')],
        favourites: 51,
        views: 337,
        tags: ['#Sakure', '#Flowers', '#Nihon'],
        dateUploaded: new Date('2021-12-23T18:25:43.511Z'),
        dateTaken: new Date('2013-07-23T18:25:43.511Z'),
        location: new mongoose.Types.ObjectId('608d5450ec00005468604a0c'),
        ...
        peopleTagged: [
          {
            _id: new mongoose.Types.ObjectId('609083a8a127743ad03ff9ec'),
            userId: new mongoose.Types.ObjectId('608d55c7e512b74ee00791de'),
            tagDate: new Date('2021-12-13T18:25:43.511Z'),
          },
        ],
        __v: 0,
      },
